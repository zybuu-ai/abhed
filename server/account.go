...
button{margin-top:18px;width:100%;padding:10px;border:0;border-radius:6px;background:var(--acc);color:var(--acc-ink);font-weight:600;font:inherit;cursor:pointer}
